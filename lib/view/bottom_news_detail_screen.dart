...
class BottomNewsDetailScreen extends StatefulWidget {
  final String newsImage, newsTitle, newsDate, author, discrption, content, source;
  
  const BottomNewsDetailScreen({
    super.key,
  ...
  @override
  State<BottomNewsDetailScreen> createState() => _BottomNewsDetailScreenState();
}

class _BottomNewsDetailScreenState extends State<BottomNewsDetailScreen> {
